  ...
  return (
    <>
      ...
      >
        ...
        {/* Add your button icon/svg here */}
      </button>

      <div
        ref={sidebarRef}
        id="docs-sidebar"
        className={`hs-overlay transition-all duration-300 transform fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white dark:bg-[#181818] dark:border-[#262626] border-e border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:end-auto lg:bottom-0 ${
      ...
      >
        ...
        >
          <ul className="space-y-1.5">
            <li>
              <a
                className="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-slate-700 rounded-lg hover:bg-gray-200 dark:hover:bg-[#39383F] dark:bg-[#252427] dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="#"
              >
                <svg
                  className="w-4 h-4"
